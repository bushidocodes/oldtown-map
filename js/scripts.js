...
var ViewModel = /*#__PURE__*/_createClass(function ViewModel() {
  ...
  _defineProperty(this, "searchString", ko.observable(''));
  _defineProperty(this, "showFavoritesOnly", ko.observable(false));
  ...
  _defineProperty(this, "filteredSites", ko.computed(function () {
    var sites = _this.showFavoritesOnly() ? _this.sites().filter(function (site) {
      return site.isFavorite();
    }) : _this.sites();
    if (_this.searchString() === '') {
      return sites;
    }
    var filter = _this.searchString().toLowerCase();
  ...
  _defineProperty(this, "selectSite", function (site) {
  ...
  _defineProperty(this, "toggleShowFavorites", function () {
    _this.showFavoritesOnly(!_this.showFavoritesOnly());
  });
  _defineProperty(this, "toggleFavorite", function (site) {
  ...
  _defineProperty(this, "highlightMarkerOfSite", function (site) {
    var _markers$find;
    (_markers$find = markers().find(function (m) {
      return m.title === site.name;
    })) === null || _markers$find === void 0 || _markers$find.setIcon(highlightedIcon);
  });
  _defineProperty(this, "unhighlightMarkerOfSite", function (site) {
    var marker = markers().find(function (m) {
      return m.title === site.name;
    });
  ...
  _defineProperty(this, "selectMarker", function (marker) {
    var site = _this.sites().find(function (s) {
